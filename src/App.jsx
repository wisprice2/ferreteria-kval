        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-16">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-2xl sm:text-3xl font-light text-slate-800 leading-tight">
              Somos el <strong className="font-black text-slate-900">Representante Exclusivo</strong> de Politrans Geoliner SpA en la Zona Sur del país.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-4xl mx-auto mb-16 space-y-6">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 leading-[1.05] tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600">Politrans Geoliner SpA</span>
            </h2>
            <p className="text-lg sm:text-xl text-slate-500 max-w-3xl mx-auto leading-relaxed font-light">
              Somos el <strong className="font-bold text-slate-800">representante directo</strong> de Politrans Geoliner SpA, 
            ...
            <div className="w-full lg:w-5/12 flex flex-col gap-6">
              <div className="bg-slate-900 text-white p-8 sm:p-10 rounded-3xl shadow-2xl relative overflow-hidden flex-grow">
                ...
                <div className="relative z-10 space-y-8">
                  ...
                  {/* CTA */}
                  <button
                    onClick={() => { const text = encodeURIComponent('Hola H&E, me interesa cotizar productos Politrans Geoliner SpA. ¿Pueden asesorarme?'); window.open(`https://wa.me/56966006747?text=${text}`, '_blank'); }}
